...
graph TD
    ...
    subgraph "Raspberry Pi 4 (Edge Device)"
        ...
        CPP -->|Quantized Tensors| TFLite[TensorFlow Lite Engine]
        TFLite -->|INT8 Logic| CPU[ARM Cortex-A72]
        CPP -->|JSON Results| MQTT_Lib[Mosquitto Client]
    end

    subgraph "External World"
        MQTT_Lib -->|TCP/1883| Broker[HiveMQ / EMQX Broker]
        Broker -->|WebSockets| Dashboard[Web-based UI]
        WiFi[Router/AP] -.->|WPA_Supplicant| MQTT_Lib
    end
